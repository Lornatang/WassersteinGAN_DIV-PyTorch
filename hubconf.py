...
Usage:
    import torch
    model = torch.hub.load("Lornatang/WassersteinGAN_DIV-PyTorch", "mnist", pretrained=True, image_size=28, channels=1)
"""
import torch
from torch.hub import load_state_dict_from_url

from wgandiv_pytorch.models import Generator

model_urls = {
    "mnist": "https://github.com/Lornatang/WassersteinGAN_DIV-PyTorch/releases/download/0.1.0/mnist-469fd083.pth",
    "fashion-mnist": "https://github.com/Lornatang/WassersteinGAN_DIV-PyTorch/releases/download/0.1.0/fashion_mnist-9681eda0.pth",
    "cifar10": "https://github.com/Lornatang/WassersteinGAN_DIV-PyTorch/releases/download/0.1.0/cifar10-9681eda0.pth"
}

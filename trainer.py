...
from wgandiv_pytorch.models import discriminator
from wgandiv_pytorch.utils import calculate_gradient_penalty
from wgandiv_pytorch.utils import init_torch_seeds
from wgandiv_pytorch.utils import select_device
from wgandiv_pytorch.utils import weights_init
        ...
        for epoch in range(args.start_epoch, self.epochs):
            ...
            for i, data in progress_bar:
                ...
                if (i + 1) % args.save_freq == 0:
                    ...
                    vutils.save_image(fake_images.detach(), os.path.join("output", f"fake_samples{epoch + 1}.bmp"))
